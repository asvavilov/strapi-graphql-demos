...
тестовые пользователи панели
tester1@example.com:Pa$$w0rd
tester2@example.com:Pa$$w0rd
тестовые пользователи graphql
tester3@example.com:Pa$$w0rd
tester4@example.com:Pa$$w0rd

в интерфейсе можно создать токены
